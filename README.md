# Fikran Pratama — Modern Fullstack Portfolio
...
- **Anti-AI Slop Copywriting:** Konten spesifik, padat, berorientasi hasil teknis nyata (p99 latency, SLA uptime, arsitektur microservice).
- **Sistem 2-Role:**
...
2. Buka [Vercel Dashboard](https://vercel.com) &rarr; **Add New Project** &rarr; Pilih repository ini.
