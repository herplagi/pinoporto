      ...
      setMessages([
        {
          ...
          message: 'Hi Fikran, we are building a distributed trading platform and loved your Aura Gateway project. Are you available for a contract or fulltime position?',
          is_read: false,
        ...
        },
        {
          ...
          subject: 'Next.js & Supabase Consulting',
          message: 'Hey Fikran, our team needs an architecture audit on our current Next.js 14 stack with PostgreSQL RLS. Would love to schedule a 30-min call this week.',
          is_read: true,
